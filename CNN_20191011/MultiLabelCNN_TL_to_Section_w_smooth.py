...
for line in exams:
    ...
    #                 'embedding_dimension': ld_params["EMB_DIM"],
    ...
    valid[hyper_params['EXAM_NUM']] = est.evaluate(dataset.eval_input_fn, steps=10)
    print(valid)
    with open(data_out_path + str(hyper_params['EXAM_NUM']) + '_' + result_file, 'w+') as res:
