    ...
    def build_freq(self, word_list):
       ...
       # print('word_counts_2: ', len(word_counts.most_common()), word_counts.most_common())
        ...
        for word, cnt in word_counts.items():
            ...
            freq[word] += cnt  # orth_	unicode	Verbatim text content (identical to Token.text). Exists mostly for consistency with the other attributes.
            print(word, freq[word])
