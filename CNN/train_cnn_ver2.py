...
"""
tf.app.flags
 - 기본 제공되는 DEFINE_*** 함수를 통해 [key, value, 도큐먼트 스트링 값] 형식의 데이터를 정의
 - 정의된 값은 flags.FLAGS를 통해 호출하여 사용
 - FLAGS = flags.FLAGS 로 모든 값들을 가져와서 FLAGS.learning_rate 와 같이 사용하면 0.01의 값이 출력되는 것을 확인할 수 있습니다.
출처: https://daeson.tistory.com/256 [대소니]
"""
...
#     train_data = dh.load_data_and_labels_v2(FLAGS.training_data_file, FLAGS.num_classes,
...
#     val_data = dh.load_data_and_labels_v2(FLAGS.validation_data_file, FLAGS.num_classes,
#                                           FLAGS.embedding_dim, data_aug_flag=False)
#
